...
const createDefaultData = (): ProductData => ({
  ...
  description_mn: 'Газраа барьцаалж, урт хугацаагаар зээл авах боломжтой.',
  description_en: 'Use your land as collateral to get a long-term loan.',
  description_style: {
    color: '#334155',
  ...
  detailsSubtitle_mn: 'Газар барьцаалсан зээл',
  detailsSubtitle_en: 'Land Collateral Loan',
...
export default function LandCollateralLoanAdminPage() {
  ...
  return (
    <AdminLayout title="Газар барьцаалсан зээл">
      <div className="max-w-6xl mx-auto">
        ...
        <PageHeader
          ...
          description="Газар барьцаалсан зээлийн хуудсын агуулга"
          action={
            <SaveResetButtons 
