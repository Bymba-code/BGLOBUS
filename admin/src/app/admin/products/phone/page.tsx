...
const createDefaultData = (): ProductData => ({
  ...
  name_mn: 'Утас авах зээл',
  name_en: 'Phone Purchase Loan',
  name_style: {
    color: '#0f172a',
  ...
  category_mn: 'Электроник · Утас',
  category_en: 'Electronics · Phone',
  category_style: {
    color: '#64748b',
  ...
  description_mn: 'Шинэ болон хуучин утас худалдан авахад зориулсан зээл.',
  description_en: 'Loan for purchasing new or used phones.',
  description_style: {
    color: '#334155',
  ...
  detailsSubtitle_mn: 'Утас авах зээл',
  detailsSubtitle_en: 'Phone Purchase Loan',
...
export default function PhonePurchaseLoanAdminPage() {
  const { data, setData, saveSuccess, handleSave: handleLocalSave, handleReset } = useSaveReset<ProductData>('productPhone', createDefaultData)
  ...
  return (
    <AdminLayout title="Утас авах зээл">
      <div className="max-w-6xl mx-auto">
        ...
        <PageHeader
          title="Утас авах зээл"
          description="Утас авах зээлийн хуудсын агуулга"
          action={
            <SaveResetButtons 
