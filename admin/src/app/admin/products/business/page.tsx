...
const createDefaultData = (): ProductData => ({
  ...
  description_mn: 'Бизнесээ өргөжүүлэх, хөгжүүлэхэд зориулсан зээл.',
  description_en: 'Loan designed to expand and develop your business.',
  description_style: {
    color: '#334155',
  ...
  detailsSubtitle_mn: 'Бизнес зээл',
  detailsSubtitle_en: 'Business Loan',
  ...
  return (
    <AdminLayout title="Бизнес зээл">
      <div className="max-w-6xl mx-auto">
        ...
        <PageHeader
          title="Бизнес зээл"
          description="Бизнес зээлийн хуудсын агуулга"
          action={
            <SaveResetButtons 
