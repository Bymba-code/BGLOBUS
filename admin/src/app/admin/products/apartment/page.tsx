...
const createDefaultData = (): ProductData => ({
  ...
  description_mn: 'Орон сууцаа барьцаалж, том хэмжээний зээл авах боломжтой.',
  description_en: 'Use your apartment as collateral to get a large loan.',
  description_style: {
    color: '#334155',
  ...
  detailsSubtitle_mn: 'Орон сууц барьцаалсан зээл',
  detailsSubtitle_en: 'Apartment Collateral Loan',
...
export default function ApartmentCollateralLoanAdminPage() {
  ...
  return (
    <AdminLayout title="Орон сууц барьцаалсан зээл">
      <div className="max-w-6xl mx-auto">
        ...
        <PageHeader
          ...
          description="Орон сууц барьцаалсан зээлийн хуудсын агуулга"
          action={
            <SaveResetButtons 
        ...
        <div className="space-y-6">
          ...
          <LocalizedListEditor
            ...
            inputLabel={{ mn: 'Материал', en: 'Material' }}
          />
          ...
          <LocalizedListEditor
            ...
            inputLabel={{ mn: 'Барьцаа', en: 'Collateral' }}
          />
          ...
          <LocalizedListEditor
            ...
            inputLabel={{ mn: 'Нөхцөл', en: 'Condition' }}
          />
        </div>
      </div>
    </AdminLayout>
