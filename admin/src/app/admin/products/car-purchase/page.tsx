...
const createDefaultData = (): ProductData => ({
  ...
  category_mn: 'Тээврийн хэрэгсэл · Автомашин',
  category_en: 'Vehicle · Car Purchase',
  category_style: {
    color: '#64748b',
  ...
  detailsSubtitle_mn: 'Автомашин авах зээл',
  detailsSubtitle_en: 'Car Purchase Loan',
  ...
  materials: [
    ...
    { id: crypto.randomUUID(), mn: 'Худалдан авах машины мэдээлэл', en: 'Car purchase information' },
    { id: crypto.randomUUID(), mn: 'Оршин суугаа хаягийн лавлагаа', en: 'Residence certificate' },
    { id: crypto.randomUUID(), mn: 'Иргэний үнэмлэхийн хуулбар', en: 'ID copy' },
  ],
  ...
  collateral: [
    { id: crypto.randomUUID(), mn: 'Худалдан авч буй автомашин', en: 'Vehicle being purchased' }
  ],
  ...
  conditions: [
    { id: crypto.randomUUID(), mn: 'Авч буй автомашин нь 2010 оноос хойш үйлдвэрлэгдсэн байх', en: 'Vehicle must be manufactured after 2010' },
    { id: crypto.randomUUID(), mn: 'Урьдчилгаа төлбөр 20-30%', en: 'Down payment 20-30%' },
    { id: crypto.randomUUID(), mn: 'Тогтмол орлоготой байх', en: 'Must have stable income' },
  ],
...
export default function CarPurchaseLoanAdminPage() {
  const { data, setData, saveSuccess, handleSave: handleLocalSave, handleReset } = useSaveReset<ProductData>('productCarPurchase', createDefaultData)
  ...
  return (
    <AdminLayout title="Автомашин авах зээл">
      <div className="max-w-6xl mx-auto">
        ...
        <PageHeader
          ...
          description="Автомашин авах зээлийн хуудсын агуулга"
          action={
            <SaveResetButtons 
