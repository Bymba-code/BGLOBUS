...
const createDefaultData = (): ServiceData => ({
  ...
  description_en: 'Trust service. Asset management service for investments, real estate, and other assets.\n\nThis service will introduce you to the necessary documents and conditions.',
  stats: {
  ...
  materials: [
    { id: crypto.randomUUID(), mn: 'Итгэмжлэгдэх хөрөнгийн жагсаалт', en: 'List of assets to be managed' },
    { id: crypto.randomUUID(), mn: 'Итгэмжлэгчийн биеийн баримт', en: 'Beneficiary personal document' },
    { id: crypto.randomUUID(), mn: 'Хүлээн авагчийн мэдээлэл', en: 'Trustee information' },
    { id: crypto.randomUUID(), mn: 'Компанийн баримт бичиг (хуулийн этгээд бол)', en: 'Company documents (if legal entity)' },
    { id: crypto.randomUUID(), mn: 'Гэрээний төсөл', en: 'Contract draft' },
  ],
  collateral: [],
  conditions: [
    { id: crypto.randomUUID(), mn: 'Итгэмжлэгдэх хөрөнгө хууль ёсны байх', en: 'Assets must be legally held' },
    { id: crypto.randomUUID(), mn: 'Итгэмжлэлийн нөхцөл тодорхой байх', en: 'Trust conditions must be clear' },
    { id: crypto.randomUUID(), mn: 'Талууд гэрээнд гарын үсэг зурна', en: 'All parties must sign the agreement' },
...
export default function TrustServiceAdminPage() {
    ...
    async (mode: 'auto' | 'manual') => {
      try {
        ...
        const response = await fetch('/api/admin/services', {
          ...
          body: JSON.stringify({ ...data, type: 'trust', mode }),
        })
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Input
                  label="Ангилал (МН) *"
                  placeholder="Жишээ: Үйлчилгээ · Итгэлцэл"
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Input
                  ...
                  placeholder="Жишээ: Тохиролцсоноор"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Textarea
                ...
                rows={4}
                helper="Монгол хэл дээрх үндсэн тайлбар"
              ...
              <Textarea
                ...
                rows={4}
                helper="Main description in English"
                onChange={(e) => updateData((prev) => ({ ...prev, description_en: e.target.value }))}
              />
            </div>
          </div>

          {/* Materials - Full Width Stacked */}
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h3 className="text-sm font-semibold text-gray-600 mb-4 uppercase flex items-center gap-2">
                <span></span> Материал
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              {(data.blocks || []).length === 0 ? (
                <p className="text-sm text-gray-500 italic">Бүтээн байгуулалтын блок байхгүй. Шинэ блок нэмхүүлэхийн тулд дээрх товчлуур дээр дарна уу.</p>
              ) : (
                (data.blocks || []).map((block, idx) => (
                  <div key={block.id} className="p-4 bg-gray-50 rounded-lg border border-gray-200 space-y-3">
                    <div className="flex justify-between items-center pb-2 border-b border-gray-200">
                      <span className="text-xs font-semibold text-gray-500">Блок #{idx + 1}</span>
                      <button
                        onClick={() => {
                          updateData((prev) => ({
                            ...prev,
