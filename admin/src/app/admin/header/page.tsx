...
// ⚠️ ЭНДЭЭС API ENDPOINT-ОО СОЛИНО УУ!
const API_BASE_URL = 'http://127.0.0.1:8000/api/v1/headers/1'
...
export default function HeaderPage() {
  ...
  const loadDefaultData = () => {
    const defaultItems: MenuItem[] = [
      { id: '1', title_mn: 'Бүтээгдэхүүн', title_en: 'Products', href: '#', order: 0, isActive: true, parentId: null, level: 0 },
      { id: '2', title_mn: 'Автомашины зээл', title_en: 'Car Loan', href: '#', order: 0, isActive: true, parentId: '1', level: 1 },
      { id: '3', title_mn: 'Барьцаалсан зээл', title_en: 'Collateral Loan', href: '/products/car-loan/collateral', order: 0, isActive: true, parentId: '2', level: 2 },
      { id: '11', title_mn: 'Үйлчилгээ', title_en: 'Services', href: '#', order: 1, isActive: true, parentId: null, level: 0 },
      { id: '17', title_mn: 'Бидний тухай', title_en: 'About Us', href: '#', order: 2, isActive: true, parentId: null, level: 0 },
      { id: '20', title_mn: 'Мэдээлэл', title_en: 'News', href: '/news', order: 3, isActive: true, parentId: null, level: 0 },
    ]
              ...
              <div className="p-6 pb-32 overflow-visible min-h-[200px]">
                ...
                >
                  <div className="px-6 flex items-center justify-between" style={{ height: headerStyle.height }}>
                    ...
                    <div className="flex items-center gap-3">
                      {headerStyle.logoUrl ? (
                        <img src={headerStyle.logoUrl} alt="Logo" className="h-10 w-auto object-contain" />
                      ) : (
                  ...
                  {headerStyle.logoUrl && (
                    <div className="mt-4 p-3 bg-white rounded-lg border border-slate-200">
                      ...
                      <div className="flex items-center justify-center p-4 bg-slate-100 rounded-lg">
                        <img src={headerStyle.logoUrl} alt="Logo" className="max-h-16 w-auto object-contain" />
                      </div>
                    </div>
                  )}
                </div>
        ...
        <Modal isOpen={modalOpen} onClose={handleCloseModal} title={editingItem ? 'Цэс засварлах' : 'Шинэ цэс нэмэх'} size="sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <select value={selectedPage} onChange={(e) => handlePageSelect(e.target.value)} className="w-full px-3 py-2.5 rounded-lg border border-slate-200 text-sm">
